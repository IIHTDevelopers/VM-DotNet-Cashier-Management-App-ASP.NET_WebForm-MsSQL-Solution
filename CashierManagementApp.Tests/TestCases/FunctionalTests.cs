...
namespace CashierManagementApp.Tests.TestCases
{
    public class FunctionalTests
    {
        ...
        [Fact]
        public async Task<bool> Testfor_Update_Cashier_NotNull()
        {
            //Arrange
            var res = false;
        ...
        [Fact]
        public async Task<bool> Testfor_GetAll_Cashier_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_UpdateCashier_ReturnsString()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_AllCashier_ReturnsString()
        {
            //Arrange
            var res = false;
            string testName; string status;
