<%@ Page Title="Cashier Management" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CashierManagement.aspx.cs" Inherits="CashierManagementApp.CashierManagement" %>
                                    ...
                                    <div class="form-group">
                                        <div class="table-responsive">
                                            <asp:GridView ID="gv" Width="100%" AutoGenerateColumns="false" OnSelectedIndexChanged="gv_SelectedIndexChanged" runat="server">
                                                <Columns>
                                                    <asp:BoundField DataField="CashierId" HeaderText="Cashier ID" SortExpression="CashierId" />
